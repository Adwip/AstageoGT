...
<html lang="en">
  <head>
    ...
    <title>BMKG DIY | Akses terbatas</title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <h1>Anda tidak memiliki akses ke  subsistem ini</h1><br>
              <h3>Silahkan menghubungi admin utama untuk mengubah akses</h3>
            </div>
          </div>
        </div>
        <!-- /page content -->
        <!-- footer content -->
        <footer>
          <div class="pull-right"> Design By Gentelella & Colorlib, system by KP Teknik Informatika UII 2015
          </div>
