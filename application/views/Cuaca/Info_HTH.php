...
<html lang="en">
  <head>
    ...
    <title>BMKG DIY | Hari Tanpa Hujan </title>
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Hari Tanpa Hujan Yogyakarta</h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h5>Data Hari Tanpa Hujan Dinamika Atmosfer</h5>
                  ...
                  <div class="x_content" >
                    <br />
                    <form method="GET" action="<?php site_url('Cuaca/info_HTH') ?>">
                    ...
                    <br>
                      <form class="form-horizontal form-label-left input_mask" method="POST" action="<?php echo site_url('Cuaca/del_hth') ?>" id="del">
    ...
    <script>
      $(document).ready(function(){
        edit_hth('<?php echo site_url('Cuaca/edit_req_hth') ?>')
        baca_data2('<?php echo site_url('Cuaca/get_hth_r') ?>')
        foto_hbl('<?php echo base_url('../File_BMKG/Iklim/Informasi_iklim/Informasi_HTH/') ?>','foto-size-ipt')
      })
    </script>
  </body>
</html>