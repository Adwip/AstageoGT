...
<html lang="en">
  <head>
    ...
    <title>BMKG DIY | Tren Suhu </title>
  ...
  <body class="nav-md">
          ...
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form method="GET" action="<?php echo site_url('Cuaca/TCH') ?>">
                    ...
                    <br />
                    <br>
                    <form method="POST" action="<?php echo site_url('Cuaca/del_tsh') ?>" id="del">
                  ...
                  <div>
                    <form action="<?php echo site_url('Cuaca/TCH') ?>">
                      <ul class="navigasi">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content" style="display: none;">
                    <br />
                    <form method="POST" action="<?php echo site_url('Cuaca/set_tren_suhu') ?>" id="kirim-data2">
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h5>Edit data tren suhu</h5>
                  </div>

                  <div class="x_content edit-form" style="display: none;">
                      <form action="<?php echo site_url('Cuaca/edit_tsh') ?>"  id="kirim-data3" method="POST">
                        <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <span>
                            ...
                            <input style="margin-top: 10px; margin-bottom: 10px;" type="file" name="tsh[]" multiple />
                          </span>
                          </div>
                        </div>
                        <div class="form-group">
    ...
    <script>
      $(document).ready(function(){
        edit_req_tsh('<?php echo site_url('Cuaca/get_tsh_id') ?>')
        baca_data2('<?php echo site_url('Cuaca/get_tsh_r') ?>')
        get_galeri('<?php echo site_url('Cuaca/baca_gambar') ?>','tsh')
