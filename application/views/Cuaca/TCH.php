...
<html lang="en">
  <head>
    ...
    <title>BMKG DIY | Tren Curah Hujan  </title>
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main" id="list-data">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Daftar berita tren curah hujan</h2>
                  ...
                  <div class="x_content">
                    ...
                    <br />
                    <br>
                    <form method="POST" action="<?php echo site_url('Cuaca/del_tch') ?>" id="del" >
    ...
    <script>
      $(document).ready(function(){
        edit_req_tch('<?php echo site_url('Cuaca/get_tch_id') ?>')
        baca_data2('<?php echo site_url('Cuaca/get_tch_r') ?>')
        get_galeri('<?php echo site_url('Cuaca/baca_gambar') ?>','tch')
