...
<html lang="en">
  <head>
    ...
    <title>BMKG DIY | Informasi SPM </title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Data <i>Suspended Particular Mater</i> di DIY</h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-input" id="form-input" style="display: none;">
                      ...
                      <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                        <label>Indeks Ph</label>
                          <input autocomplete="off" required="required" type="text" class="form-control indeks-form " name="indeks">
                      </div>
                    ...
                    <div class="form-keterangan"  style="display: none;">
                      <form method="POST" id="kirim-data" class="set_form_ket" action="<?php echo site_url('Cuaca/set_ket_spm') ?>" >
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                          <label>Bulan</label>
                      ...
                      <!------------------------------->
                      <form  method="POST" class="edit_form_ket" id="kirim-data" action="<?php echo site_url('Cuaca/edit_ket_spm') ?>" >
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                          <label>Bulan</label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                          <label>Keterangan</label>
                          <textarea rows="10" id="edit_ket_isi" class="form-control" name="keterangan"></textarea>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                          <button type="submit" class="btn btn-primary">Kirim</button>
                        </div>
...
<!--Batas golongan kepangkatan pns-->
    ...
    <script>
       $(document).ready(function(){
        ...
        var data1 = JSON.parse('<?php echo  $grafik ?>')
        //data1.push({name:"Bulan", data:[1,2,3,4]})

        grafikSPM ('#container',data1 , '2019','<?php echo date('d-m-Y') ?>')
        del_ext('<?php echo site_url('Cuaca/del_ket_spm') ?>')
        get_edit_ket('<?php echo site_url('Cuaca/get_spm_ket') ?>')
      })
