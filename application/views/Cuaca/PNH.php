...
<html lang="en">
  <head>
    ...
    <title>BMKG DIY | Perubahan normal hujan </title>
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Perubahan normal hujan di DIY</h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Daftar berita perubahan normal hujan</h2>
                  ...
                  <div class="x_content">
                    <form method="GET" action="<?php echo site_url('Cuaca/PNH') ?>">
                    ...
                    <br />
                    <br>
                    <form method="POST" action="<?php echo site_url('Cuaca/del_pnh') ?>" id="del" >
                  ...
                  <div>
                    <form action="<?php echo site_url('Cuaca/PNH') ?>">
                      <ul class="navigasi">
    ...
    <script>
      $(document).ready(function(){
        edit_req_pnh('<?php echo site_url('Cuaca/get_pnh_id') ?>')
        baca_data2('<?php echo site_url('Cuaca/get_pnh_r') ?>')
        get_galeri('<?php echo site_url('Cuaca/baca_gambar') ?>','pnh')
